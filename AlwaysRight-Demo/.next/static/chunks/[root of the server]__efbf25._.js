(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__efbf25._.js", {
...
"[project]/src/utils/auth0-config.ts [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const auth0Config = {
    ...
    authorizationParams: {
        redirect_uri: ("TURBOPACK compile-time truthy", 1) ? window.location.origin : ("TURBOPACK unreachable", undefined)
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__efbf25._.js.map