...
function Dashboard() {
    ...
    const calculateRealTimeStats = async ()=>{
        try {
            ...
            // 获取实际的产品数量
            const totalProducts = products.length || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockProducts$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["mockProducts"].length; // 如果 localStorage 为空则使用 mockProducts
            // 更新统计数据
            setStats({
                totalSales,
                totalOrders,
            ...
            setStats({
                ...
                totalOrders: 0,
                totalCustomers: 0,
                totalProducts: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockProducts$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["mockProducts"].length
            });
        }
    };
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__60d4f6._.js.map